...
import (
	...
	"oofoghlu/fuzzycron/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d4faf493.oofoghlu",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&batchv1.FuzzyCronJob{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "FuzzyCronJob")
			os.Exit(1)
		}
	}
